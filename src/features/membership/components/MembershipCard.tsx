...
export function MembershipCard({ pkg, onClick }: MembershipCardProps) {
  return (
    <div
      onClick={onClick}
      className="relative overflow-hidden rounded-[20px] bg-linear-to-br from-[#2f4b7c] to-[#1e3a5f] text-white p-8 aspect-4/2.5 flex flex-col items-center justify-center shadow-md cursor-pointer hover:shadow-lg transition-transform hover:-translate-y-1 group"
    >
