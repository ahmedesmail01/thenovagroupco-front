export function TopStatCard({
  ...
  return (
    <div className="bg-white rounded-[16px] px-[32px] py-[10px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 flex flex-col justify-center relative overflow-hidden h-34">
      {/* Accent Bar */}
      <div
